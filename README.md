...
### [CryptoAlertBot](https://github.com/Enmilo-dev/crypto-alert-bot) — Production-grade Telegram alert system
...
|---|---|---|
| [Crypto-Market-Fetcher](https://github.com/Enmilo-dev/Crypto-Market-Fetcher) | C++, cURL | High-performance CLI ingesting live crypto ticks with thread pooling |
| [TradeSim](https://github.com/Enmilo-dev/TradeSim) | C++, STL | Market exchange simulator with order book matching and latency analysis |
| [Crypto Data API](https://github.com/Enmilo-dev/crypto-alert-bot) | Node.js, Express | RESTful API aggregating real-time prices across multiple exchanges |
...
*Building in public · [x.com/EnmiloX](https://x.com/EnmiloX)*
